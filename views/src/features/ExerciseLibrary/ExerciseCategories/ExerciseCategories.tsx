                ...
                {loading ? <div className="mt-10"><Loading /></div> : (
                    categories.map((category, index) => (
                        <button
                            ...
                            key={index}
                            className="dark:hover:bg-lightestPurple dark:hover:text-darkestPurple dark:text-lightestPurple font-semibold dark:bg-darkPurple bg-gray-100 border-2 dark:border-lightestPurple border-darkPurple text-darkestPurple rounded-md hover:text-xl hover:font-semibold  hover:bg-lightPurple text-lg p-2 w-full"
                        >{category.name}
                        </button>
                    ))
                )}
