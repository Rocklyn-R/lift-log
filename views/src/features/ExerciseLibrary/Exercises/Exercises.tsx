                        ...
                        exercises.map((exercise, index) => (
                            <div key={index} className="relative w-full">
                                ...
                                <button
                                    ...
                                    className={`exercise-button relative z-10 bg-gray-100 border-2 border-darkestPurple rounded-md shadow-lg ${openDropdown ? "" : "hover:font-semibold hover:text-xl hover:bg-lightPurple"} text-lg p-2 w-full flex justify-center`}
                                >
                                    ...
                                    <>
                                        ...
                                        <div className="absolute right-2 top-1/2 -translate-y-1/2 z-20">
                                            <div
                                                ...
                                                className={`${openDropdown === exercise.exercise_id ? "border-2 border-darkestPurple bg-lightPurple" : "border-2 border-transparent"} p-2 hover:border-2 hover:border-darkestPurple hover:bg-lightPurple rounded-full cursor-pointer box-border`}
                                            >
                                        ...
                                        {openDropdown === exercise.exercise_id && (
                                            <div
                                                ref={dropdownRef}
                                                className="border-darkestPurple border-2 absolute right-2 top-7 mt-2 w-32 bg-white rounded-md shadow-lg z-50"
                                            >
                                                <div
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                    ...
                                                    className="flex justify-between items-center rounded-t-md w-full text-left px-4 py-2 text-md text-darkestPurple hover:bg-lightestPurple cursor-pointer"
                                                >
                                                    <span> Edit</span>
