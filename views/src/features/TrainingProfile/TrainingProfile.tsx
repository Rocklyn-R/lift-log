                ...
                <div className=" sm:text-base text-base w-full flex justify-center h-full">
                    <div className=" dark:bg-darkestPurple rounded-none sm:rounded-md border-mediumPurple bg-lightestPurple lg:w-1/3 md:w-2/3 sm:w-3/4 w-full h-fit py-4 sm:py-4 sm:px-4">
                            ...
                            <div className="flex items-center justify-between text-darkestPurple w-full space-x-4">
                                {showTrainingGoal ? (
                                    ...
                                    <div className="flex w-full justify-between items-center">
                                        ...
                                        <button onClick={() => setShowTrainingGoal(true)} className="bg-darkestPurple dark:border-mediumPurple border-transparent hover:bg-darkPurple text-lightestPurple mt-2 flex items-center justify-center dark:text-lightestPurple border-2 rounded-full p-[.80rem] dark:bg-darkPurple dark:hover:bg-lightestPurple dark:hover:text-darkestPurple hover:border-darkPurple dark:hover:border-mediumPurple"><MdOutlineEdit className="text-xl" /></button>
                                    </div>
                                )}
                            ...
                            <div className="flex items-center w-full justify-between text-darkestPurple space-x-4">
                                {showBodyCompositionGoal ? (
                                    <>
                                        ...
                                        />
                                        <div className="flex space-x-2 items-center">
                                            <button onClick={() => handleChangeBodyCompositionGoal()} className="mt-2  border-transparent bg-darkestPurple hover:bg-darkPurple text-lightestPurple flex items-center justify-center dark:text-lightestPurple border-2 rounded-full p-3 dark:bg-darkPurple dark:hover:bg-lightestPurple dark:hover:text-darkestPurple h-fit hover:border-darkPurple dark:border-mediumPurple dark:hover:border-mediumPurple"><FaCheck className="text-xl" /></button>
                                            <button onClick={() => {
                                    ...
                                    <div className="flex w-full justify-between items-center">
                                        ...
                                        <button onClick={() => setShowBodyCompositionGoal(true)} className="mt-2 dark:border-mediumPurple flex items-center justify-center text-lightestPurple bg-darkestPurple hover:bg-darkPurple border-transparent dark:text-lightestPurple p-3 border-2 rounded-full dark:bg-darkPurple dark:hover:bg-lightestPurple dark:hover:text-darkestPurple hover:border-darkPurple dark:hover:border-mediumPurple"><MdOutlineEdit className="text-xl" /></button>
                                    </div>
                                )}
                        ...
                        <div className="mb-4 sm:border-2 border-y-2 border-mediumPurple bg-lightestPurple sm:p-4 p-2 rounded-none sm:rounded-md dark:bg-darkestPurple">
                            ...
                            <div className="relative flex items-center w-full justify-between dark:text-lightestPurple text-darkestPurple space-x-4">
                                {showInjuries ? (
                                    <>
                                    ...
                                    <div className="flex w-full justify-between items-center">
                                        ...
                                        }} className="mt-2 dark:border-mediumPurple flex items-center justify-center text-lightestPurple bg-darkestPurple hover:bg-darkPurple border-transparent dark:text-lightestPurple p-3 border-2 rounded-full dark:bg-darkPurple dark:hover:bg-lightestPurple dark:hover:text-darkestPurple hover:border-darkPurple dark:hover:border-mediumPurple"><MdOutlineEdit className="text-xl" /></button>
                                    </div>
                                )}
